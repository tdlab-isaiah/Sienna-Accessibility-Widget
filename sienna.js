...
var init = function() {
    ...
    var barColor =    hslToHex((223 +  hue - hueOffset) % 360, 97, 35); //original: '#0334b1', for top bar color
    let iconColor =   hslToHex((223 +  hue - hueOffset) % 360, 97, 35); // was '#0048ff', for main icon, borders and card selected background
    
    var tileColor =   hslToHex((218 +  hue - hueOffset) % 360, 100, 96); // original: '#ecf3ff', for tile background
    var buttonColor =  hslToHex((223 +  hue - hueOffset) % 360, 97, 35); //was original: '#0648ff' font button color
    var boxShadow1 =  hslToHex((233 +  hue - hueOffset) % 360, 45, 26); // original '#252c61', rgb(37 44 97 / 15%)
    var boxShadow2 =  hslToHex((232 +  hue - hueOffset) % 360, 23, 47); // originsl: '#5d6494', rgb(93 100 148 /20%)
